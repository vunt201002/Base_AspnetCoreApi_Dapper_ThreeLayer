...
using Base_AspnetCoreApi_Dapper_ThreeLayer.DL.Context;
using Dapper;
...
{
    /// <summary>
    /// Lớp repo triển khai, sử dụng Dapper
    /// gọi tới procedure. Tên procedure
    /// dạng: sp_action_tableName
    /// (sp_update_fixed_asset)
    /// </summary>
    ...
    public abstract class BaseRepository<TEntity> : IBaseRepository<TEntity>
    {
        ...
        public virtual async Task<int> AddAsync(TEntity entity)
        {
            ...
            // chuyển tên bảng từ pascal case
            // sang snake case.
