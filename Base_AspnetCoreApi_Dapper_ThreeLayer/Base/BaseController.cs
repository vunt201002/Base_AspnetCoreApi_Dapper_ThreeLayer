using Base_AspnetCoreApi_Dapper_ThreeLayer.BL.Base;
using Microsoft.AspNetCore.Mvc;

namespace Base_AspnetCoreApi_Dapper_ThreeLayer.Base
{
    [ApiController]
    public abstract class BaseController<TEntityDto, TEntityCreateDto, TEntityUpdateDto> : Controller
    {
        #region properties
